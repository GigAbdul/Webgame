...
import { createEmptyPlayerSkinData, createEmptyPlayerSkinRecord, createPlayerSkinLayer, normalizePlayerSkinData, playerSkinEditorConfigs, usePlayerSkinsQuery, } from '../features/game/player-skins';
...
function serializeSkinData(skinData) {
...
export function AdminPlayerSkinsPage() {
    ...
    const dirtyModes = useMemo(() => playerModes.filter((mode) => serializeSkinData(histories[mode].present) !== serializeSkinData(serverDrafts[mode])), [histories, serverDrafts]);
