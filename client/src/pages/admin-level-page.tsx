...
const difficulties: Difficulty[] = ['EASY', 'NORMAL', 'HARD', 'HARDER', 'INSANE', 'DEMON'];
...
export function AdminLevelPage() {
  ...
  useEffect(() => {
    ...
    setForm({
      ...
      starsReward: level.starsReward || 1,
      status: level.status,
        ...
        <div className="grid gap-6 px-5 py-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-8">
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {level.difficulty ? <Badge>{level.difficulty}</Badge> : null}
            </div>
          </div>
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            ...
            <div className="game-stat px-4 py-4">
              ...
              <p className="mt-2 font-display text-xl text-white">{level.difficulty ?? 'NORMAL'}</p>
            </div>
            <div className="game-stat px-4 py-4">
        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(event) => setForm((current) => ({ ...current, starsReward: Number(event.target.value) }))}
                />
              </div>
            </div>
            <div className="grid grid-cols-2 gap-3">
          ...
          <Panel className="game-screen space-y-3 bg-transparent">
            ...
            <p className="text-sm leading-7 text-white/78">
              Star reward редактируется только тут. При publish и recalculation backend пересчитывает и синхронизирует
              лидерборд.
            </p>
