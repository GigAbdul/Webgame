...
export function getStageThemePalette(theme) {
    return STAGE_THEME_PALETTES[theme] ?? STAGE_THEME_PALETTES['neon-grid'];
}
export function getDefaultStageGroundColor(theme) {
    return getStageThemePalette(theme).groundBaseColor;
}
export function getStageGroundPalette(theme, overrideColor) {
